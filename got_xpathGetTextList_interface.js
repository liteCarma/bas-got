<div class="container-fluid">
	...
	<%= _.template($('#variable_constructor').html())({id:"save", description:tr("Variable To Save"), default_variable: "XPATH_TEXT_LIST", help: {description: tr("Varibale, which will contain list of all elements text, which matches xpath query.")}}) %>
  <div class="col-xs-12">
