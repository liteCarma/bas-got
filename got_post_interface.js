<div class="container-fluid">
    ...
    <span data-preserve="true" data-preserve-type="check" data-preserve-id="useConstructor">
      <input type="checkbox" id="useConstructor" onclick="$('#WithPostData').toggle();$('#NoPostData').toggle()"/> <label for="useConstructor" class="tr">Post data constructor</label>
    </span>
    <hr style="margin-top:5px;margin-bottom:5px"/>
	</div>
	...
	<%= _.template($('#input_constructor').html())({id:"encoding", description:tr("Encoding"), default_selector: "string", disable_int:true, value_string: "UTF-8", help: {description: tr("Post data encoding. This parameter determines encoding name which will be used to process post data. This parameter doesn't change Content-Type header, you must do it yourself."), examples:[{code:"UTF-8",description:tr("It is ok for most of cases.")},{code:"WINDOWS-1251",description:tr("Used on some Russian sites.")}]}}) %>
