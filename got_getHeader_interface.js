<div class="container-fluid">
	<%= _.template($('#input_constructor').html())({id:"value", description:tr("Header Name"), default_selector: "string", disable_int:true, help: {description: tr("Response header name. Header name must contain one or several words separated with dash. Character case is not important."), examples:[{code:"Location",description:tr("Get 'Location' header.")},{code:"Content-Type",description:tr("Get 'Content-Type' header.")},{code:"cOnTeNt-tYpE",description:tr("Also gets 'Content-Type' header.")}]}}) %>
	<%= _.template($('#variable_constructor').html())({id:"save", description:tr("Variable To Save"), default_variable: "SAVED_HEADER", help: {description: tr("A variable name, which will hold header value.")}}) %>
  <div class="col-xs-12">	
