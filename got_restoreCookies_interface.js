<div class="container-fluid">
	<%= _.template($('#input_constructor').html())({id:"value", description:tr("Cookies"), default_selector: "string", disable_int:true, help: {description: tr("This field must contain string with cookies in json format. That json must hold list with all cookies for all domains. Json format is described below. Use empty string to clear cookies."), examples:[{code:tr("Empty string"),description:tr("Clear cookies")}]}}) %>
  <div class="col-xs-12">
