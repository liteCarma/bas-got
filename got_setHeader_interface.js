<div class="container-fluid">
	<%= _.template($('#input_constructor').html())({id:"name", description:tr("Header Name"), default_selector: "string", disable_int:true, value_string: "User-Agent", variants: ["User-Agent","Accept-Language"], size: 3, help: {description: tr("Request header name. Header name must contain one or several words separated with dash."), examples:[{code:"User-Agent",description:tr("Set 'User-Agent' header.")},{code:"Accept-Language",description:tr("Set 'Accept-Language' header.")},{code:"Referer",description:tr("Set referer.")}]}}) %>
	<%= _.template($('#input_constructor').html())({id:"value", description:tr("Header Value"), default_selector: "string", disable_int:true, value_string: "Mozilla/5.0 (Windows NT 6.1; WOW64; rv:44.0) Gecko/20100101 Firefox/44.0", help: {description: tr("Request header value. This could be arbitrary string.")}}) %>
  <div class="col-xs-12">
